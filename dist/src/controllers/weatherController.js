...
const weatherServices_js_1 = require("../services/weatherServices.js");
...
const getWeatherData = async (req, res) => {
    ...
    try {
        ...
        if (city === "london") {
            console.log((0, weatherServices_js_1.generateLondonWeatherData)());
            finalWeatherData = (0, weatherServices_js_1.generateLondonWeatherData)();
        }
        else if (city === "dublin") {
            finalWeatherData = (0, weatherServices_js_1.generateDublinWeatherData)();
        }
        else {
